const CarAddHTML = `
<div class="ProjectBlock" data-category="creation" data-tags="creation ni ui ux" id="CarAdd">
    <div class="Projects">
        <div class="Container">
            <div class="Project">
                <div class="Item">
                    <h1>Dixième Projet</h1>
                </div>
            </div>
        </div>
        <div class="Container">
    ...
    <div class="ProjectShowcase">
        <div class="ShowcaseMenu">
            <div class="MenuTab active" data-target="p10-tab1">
                <div class="TabHeader">
            ...
            <div class="MenuTab" data-target="p6-tab2">
                <div class="TabHeader">
            ...
            <div class="MenuTab" data-target="p10-tab3">
                <div class="TabHeader">
            ...
            <div class="MenuTab" data-target="p10-tab4">
                <div class="TabHeader">
            ...
            <div class="MenuTab" data-target="p10-tab5">
                <div class="TabHeader">
        ...
        <div class="ShowcaseContent">
            ...
            <div class="ContentPanel" id="p10-tab5">
                <div class="ContentCard">
                    <h4>en cours...</h4>
                    <p>en cours...</p>
                </div>
    ...
    <ul class="InlineMenu">
        <li><button class="InlineTab active" data-target="p10-comp1">Hero</button></li>
        <li><button class="InlineTab" data-target="p10-comp2">Formulaire de contact</button></li>
        <li><button class="InlineTab" data-target="p10-comp3">Footer</button></li>
        <li><button class="InlineTab" data-target="p10-comp4">Logo</button></li>
    </ul>
    <div class="Comparaisons" id="p10-comp1"><img src="img/Projects/CarAdd/new_hero.png" alt="Nouveau hero CarAdd" class="NewImage">
        <div class="Overlay"><img src="img/Projects/CarAdd/old_hero.png" alt="Ancien hero CarAdd" class="OldImage"></div>
        <div class="Slider"></div>
    </div>
    <div class="Comparaisons" id="p10-comp2"><img src="img/Projects/CarAdd/new_form.png" alt="Nouveau formulaire CarAdd" class="NewImage">
        <div class="Overlay"><img src="img/Projects/CarAdd/old_form.png" alt="Ancien formulaire CarAdd" class="OldImage"></div>
        <div class="Slider"></div>
    </div>
    <div class="Comparaisons" id="p10-comp3"><img src="img/Projects/CarAdd/new_footer.png" alt="Nouveau footer CarAdd" class="NewImage">
        <div class="Overlay"><img src="img/Projects/CarAdd/old_footer.png" alt="Ancien footer CarAdd" class="OldImage"></div>
        <div class="Slider"></div>
    </div>
    <div class="Comparaisons" id="p10-comp4"><img src="img/Projects/CarAdd/new_logo.svg" alt="Nouveau logo CarAdd" class="NewImage">
        <div class="Overlay"><img src="img/Projects/CarAdd/old_logo.png" alt="Ancien logo CarAdd" class="OldImage"></div>
        <div class="Slider"></div>
    </div>
</div>
`;

document.getElementById('CarAddPlaceHolder').innerHTML = CarAddHTML;