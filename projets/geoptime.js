...
<div class="ProjectBlock" data-category="creation" data-tags="creation ni ui ux" id="GeopTime">
    ...
    <div class="ProjectShowcase">
        <div class="ShowcaseMenu">
            ...
            <div class="MenuTab" data-target="p5-tab3">
                <div class="TabHeader">
            ...
            <div class="MenuTab" data-target="p5-tab4">
                <div class="TabHeader">
            ...
            <div class="MenuTab" data-target="p5-tab5">
                <div class="TabHeader">
        ...
        <div class="ShowcaseContent">
            <div class="ContentPanel active" id="p5-tab1">
                <div class="ContentCard">
                    <h4>Un site inexistant...</h4>
                    <p>GeopTime est une entreprise spécialisée dans la gestion du temps et de la localisation.</p>
                    <p>L'objectif : créer un site qui inspire confiance d'emblée et positionne clairement leur offre.</p>
                </div>
            </div>
            <div class="ContentPanel" id="p5-tab2">
                <div class="ContentCard">
                    <h4>Une création complète et moderne</h4>
                    <p>Sans véritable site à analyser, j'ai d'abord cartographié les objectifs métier : qu'est-ce que le site doit faire concrètement ? (Générer des contacts, rassurer sur l'expertise, expliquer les fonctionnalités).</p>
                    <p>Ces objectifs ont guidé la structure du zoning et la priorité des blocs d'information.</p>
                </div>
            </div>
            ...
            <div class="ContentPanel" id="p5-tab5">
                <div class="ContentCard">
                    <h4>Du full-stack pour la première fois</h4>
                    <p>C'est mon premier projet full-stack en autonomie :
                    <ul>
                        <li>HTML ;</li>
                        <li>CSS ;</li>
                        <li>JavaScript ;</li>
                    ...
                    <p>Ça m'a appris à penser le design avec les contraintes du développement en tête dès la phase de maquette, certains effets visuels séduisants en Figma sont cauchemars à implémenter.</p>
                    <p>Cette double casquette m'a rendu plus pragmatique et plus crédible face aux développeurs.</p>
                </div>
            </div>
        </div>
    </div>
    <ul class="InlineMenu">
        <li><button class="InlineTab active" data-target="p5-comp1">Hero</button></li>
        <li><button class="InlineTab" data-target="p5-comp2">Fonctionnalités</button></li>
        <li><button class="InlineTab" data-target="p5-comp3">Footer</button></li>
        <li><button class="InlineTab" data-target="p5-comp4">Logo</button></li>
    </ul>
    <div class="Comparaisons" id="p5-comp1"><img src="img/Projects/GeopTime/new_hero.png" alt="Hero GeopTime" class="NewImage">
        <div class="Overlay"><img src="img/Projects/GeopTime/old_hero.png" alt="Ancien hero GeopTime" class="OldImage"></div>
        <div class="Slider"></div>
    </div>
    <div class="Comparaisons" id="p5-comp2"><img src="img/Projects/GeopTime/new_features.png" alt="Fonctionnalités GeopTime" class="NewImage">
    ...
    <div class="Comparaisons" id="p5-comp3"><img src="img/Projects/GeopTime/new_footer.png" alt="Footer GeopTime" class="NewImage">
        <div class="Overlay"><img src="img/Projects/GeopTime/old_footer.png" alt="Ancien footer GeopTime" class="OldImage"></div>
        <div class="Slider"></div>
    </div>
    <div class="Comparaisons" id="p5-comp4"><img src="img/Projects/GeopTime/new_logo.svg" alt="Nouveau logo GeopTime" class="NewImage">
