...
<div class="ProjectBlock" data-category="creation" data-tags="creation ui ux" id="Noevell">
    ...
    <div class="ProjectShowcase">
        <div class="ShowcaseMenu">
            <div class="MenuTab active" data-target="p8-tab1">
                <div class="TabHeader">
            ...
            <div class="MenuTab" data-target="p8-tab2">
                <div class="TabHeader">
            ...
            <div class="MenuTab" data-target="p8-tab3">
                <div class="TabHeader">
            ...
            <div class="MenuTab" data-target="p8-tab4">
                <div class="TabHeader">
        ...
        <div class="ShowcaseContent">
            <div class="ContentPanel active" id="p8-tab1">
                <div class="ContentCard">
                    <h4>en cours...</h4>
                    <p>en cours...</p>
                </div>
            </div>
            <div class="ContentPanel" id="p8-tab2">
                <div class="ContentCard">
                    <h4>en cours...</h4>
                    <p>en cours...</p>
                </div>
            </div>
            <div class="ContentPanel" id="p8-tab3">
                <div class="ContentCard">
                    <h4>en cours...</h4>
                    <p>en cours...</p>
                </div>
            </div>
            <div class="ContentPanel" id="p8-tab4">
                <div class="ContentCard">
                    <h4>en cours...</h4>
                    <p>en cours...</p>
                </div>
