...
Ce projet me sert de vitrine numérique. L'objectif est de présenter mes compétences de manière **épurée**, **performante** et entièrement **responsive**.

* **Vitesse :** Optimisé pour un score Lighthouse maximal.
* **Design :** Approche "mobile-first" et interface minimaliste.
* **Contenu :** Projets sélectionnés, stack technique et liens sociaux.
